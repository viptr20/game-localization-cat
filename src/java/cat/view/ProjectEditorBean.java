...
import cat.semantic.SemanticDictionaryService;
import cat.semantic.SemanticDictionaryService.SemanticTermCandidate;
...
public class ProjectEditorBean implements Serializable {
    ...
    private List<SemanticTermCandidate> semanticTermCandidates = new ArrayList<SemanticTermCandidate>();
    ...
    private final SemanticDictionaryService semanticDictionaryService = new SemanticDictionaryService();
    ...
    private void reloadSegments() {
        ...
        semanticTermCandidates = new ArrayList<SemanticTermCandidate>();
    }
    ...
    public List<SemanticTermCandidate> getSemanticTermCandidates() {
        return semanticTermCandidates;
    }

    public void setSemanticTermCandidates(List<SemanticTermCandidate> semanticTermCandidates) {
        this.semanticTermCandidates = semanticTermCandidates;
    }
    ...
    public void loadSemanticSuggestions() {
        ...
        try {
            ...
            semanticTermCandidates = semanticDictionaryService.enrichSegment(source, sourceLang);
